...
<div class="col-md-12">
    <div class="tile">
        <a href="{{ route('admin.PDescribe_paperCons') }}" class="btn btn-primary pull-right">+ PDescribe</a>
                ...
                <table class="table table-hover table-bordered" id="">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="center">
                                @if($pdescribe->publication_status==1)
                                <a class="btn btn-danger" href="{{ route('admin.unactive_PDescribe_paperCons',$pdescribe->id)}}">
                                    <i class="halflings-icon white thumbs-down"></i>
                                </a>
                                @else
                                <a class="btn btn-success" href="{{ route('admin.active_PDescribe_paperCons',$pdescribe->id) }}">
                                    <i class="halflings-icon white thumbs-up"></i>
                                </a>
                                @endif
                                <a class="btn btn-info" href="{{ route('admin.edit_PDescribe_paperCons',$pdescribe->id) }}">
                                    <i class="halflings-icon white edit"></i>
                                </a>
                                <a class="btn btn-danger" href="{{ route('admin.delete_PDescribe_paperCons',$pdescribe->id) }}" id="delete" >
