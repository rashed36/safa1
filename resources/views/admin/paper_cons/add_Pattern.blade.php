...
<title>Add Pattern - {{ config('app.name') }}</title>
@section('content')
<div class="app-title">
    <div>
        <h1><i class="fa fa-product-hunt"></i> Add Pattern</h1>
    </div>
</div>
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="tile">
            ...
            <form action="{{ route('admin.save_pattern_paperCons') }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
