...
<title>Add Industries and Possible Applications - {{ config('app.name') }}</title>
@section('content')
<div class="app-title">
    <div>
        <h1><i class="fa fa-product-hunt"></i> Add Industries and Possible Applications</h1>
    </div>
</div>
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="tile">
            ...
            <form action="{{ route('admin.save_ipossible') }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
