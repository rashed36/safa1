...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="tile">
            ...
            <form action="{{ route('admin.update_Pimage_organic',$Pimage_info->id) }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                <div class="tile-body">
                ...
                <div class="tile-footer">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a class="btn btn-secondary" href="{{ route('admin.all_Pimage_organic') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
            </form>
        </div>
    </div>
